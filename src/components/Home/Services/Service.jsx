    ...
    return (
        <section className="container" style={{marginTop: 200, marginBottom:200}}>
            <div className='mb-5 section-title text-center'>
                <h2>Services</h2>
                <p className='m-0'>Our services are integrated with a health model automomy to patients on result diagnosis and procedure evalaution.</p>
            </div>
                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-4">
                        <div className="service-content ps-4 mt-4 mt-lg-0">
                            ...
                            <p className="mt-4 mb-5 text-secondary form-text">We provide the best leading medical services to foster result-driven and accontability base model.</p>
