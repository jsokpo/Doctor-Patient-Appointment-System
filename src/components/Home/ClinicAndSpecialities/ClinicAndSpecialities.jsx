		...
		<section className="section section-specialities position-relative">
			<div className="container-fluid">
				<div className='mb-5 section-title text-center'>
					...
					<p className='m-0'>Our Clinic and Specialities showcase our desire to be more than just doctors. We are fully committed and enlightened on the evolving health strategies to living and well-being.</p>
				</div>
