...
const CheckoutPage = ({ handleChange, selectValue, isCheck, setIsChecked, data, selectedDate, selectTime }) => {
    const { nameOnCard, cardNumber, expiredMonth, cardExpiredYear, cvv, paymentMethod } = selectValue;
    const handleCheck = () => {
        setIsChecked(!isCheck)
    }

    let price = data?.price ? data.price : 3000;
                    ...
                    <div className="rounded p-3" style={{ background: "#f8f9fa" }}>
                        ...
                        <div className="booking-item-wrap">
                            ...
                            <ul className="booking-fee">
                                ...
                                <li>Booking Fee <span>₦500</span></li>
                            ...
                            <ul className="booking-total">
                                <li className='d-flex justify-content-between'>
                                    ...
                                    <span className="total-cost" style={{ color: '#1977cc' }}>₦{(Number(price) + 500 + vat)}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
